...
# 测试时读取模型参数文件的名称
# 保存模型的目录
parser.add_argument('--save_path', type=str, default=save_path, help='The path of model to save')
...
def generate_batches(raw_data, batch_size, num_steps):
    ...
    # range_input_producer() 多线程异步读取数据
